...
export function useProgressTracking() {
	// Create state objects without runes
	const transcriptionProgress: ProgressState = {
		currentChunk: 0,
		totalChunks: 0,
		isActive: false,
	};

	const audioSplittingProgress: ProgressState = {
		currentChunk: 0,
		totalChunks: 0,
		isActive: false,
	};

	const summarizationProgress: ProgressState = {
		currentChunk: 0,
		totalChunks: 0,
		isActive: false,
	};
